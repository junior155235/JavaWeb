...
@WebServlet("/GetDistrictForNewJob")
public class GetDistrictForNewJob extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public GetDistrictForNewJob() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			try {
				...
				for(int i=0;i<districtList.size();i++) {
					outPrintString += "<option value=\"" + districtList.get(i) + "\">" + districtList.get(i) + "</option>";
				}
